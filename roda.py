...
print(*painel2)
print(*painel3)
# list da pontuação e variável do jogador atual
pontos = [0, 0, 0]
jogador_atual = 0
...
while acertos < total_letras:
    input(f"\nJogador: {nomes[jogador_atual].upper()}. Pressione ENTER oara rodar a roda...")
    ...
    if sorteio_roda == 'PASSA_A_VEZ':
        ...
        if acertos < total_letras - 3:
            ...
            # verifica se a letra já foi um palpite ultilizado
            if letra in palpites:
                ...
                print("Gostaria de digita-las? (SIM OU NÃO)?")
